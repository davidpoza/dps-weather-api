...
router.get('/logging/log/nearest/:date/:station_id', md_auth.ensureAuthenticated, LogController.getNearestData);
router.get('/logging/log/:station_id', md_auth.ensureAuthenticated, LogController.getLastData);
